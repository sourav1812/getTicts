...
import { requireAuth,RequestValidator, NotFound, OrderStatus, BadRequest } from '@ss_microservice_auth_service/common';
...
router.post('/api/orders',requireAuth,[
    ...
    if(isReserved) throw new BadRequest("Ticketed is already reserved");
